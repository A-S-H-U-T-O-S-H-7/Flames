...
export default function ListView() {
  ...
  return (
    <div className="flex-1 flex flex-col gap-4 p-5 bg-white dark:bg-[#1e2737] rounded-xl shadow-lg">
      <h1 className="text-2xl font-semibold text-gray-800 dark:text-white">Banners</h1>
        ...
        <table className="w-full border-collapse rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-[#22c7d5] text-white">
              ...
              <th className="px-4 py-3 text-left">Sub Title</th>
...
function Row({ item, index }) {
  ...
  return (
    <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
      ...
      <td className="px-4 py-3 text-gray-800 dark:text-gray-200">{item?.title}</td>
      <td className="px-4 py-3 text-center text-gray-800 dark:text-gray-200">{item?.subtitle}</td>
      <td className="px-4 py-3 text-center text-gray-800 dark:text-gray-200">{item?.buttontext}</td>
