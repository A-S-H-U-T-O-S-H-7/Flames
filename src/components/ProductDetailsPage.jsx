...
const ProductDetails = () => {
  ...
  return (
    <div className="min-h-screen  bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full mt-16  bg-white border border-gray-200 shadow-lg rounded-lg p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button className="mt-5 w-full flex gap-2 justify-center bg-gradient-to-r from-purple-500 to-purple-700 text-white py-2 px-4 rounded-lg hover:opacity-90 shadow-lg transform hover:-translate-y-1 transition">
                <ShoppingCart className="w-5 h-5" />
                Add to Cart
              </button>
              <button className="mt-5 w-full bg-gradient-to-r from-pink-500 to-pink-700 text-white py-2 px-4 rounded-lg hover:opacity-90 shadow-lg transform hover:-translate-y-1 transition">
                Buy Now
              </button>
            </div>
            ...
            <div className="space-y-3 py-4 border-t">
              <div className="flex items-center gap-2">
                <span className="w-48 text-sm md:text-base text-gray-500">
                  Estimated Delivery
                </span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-sm md:text-base text-green-600">
                  Free Shipping
                </span>
              </div>
              <div className="flex text-sm md:text-base items-center gap-2">
                <span className="w-48  text-gray-500">Return Policy</span>
