            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-6">
              ...
              <div className="flex flex-col items-center">
                ...
                <ul className="space-y-2 font-body w-full">
                  {displayCategories.length > 0 ? displayCategories.slice(0, 4).map((category) => (
                    <motion.li 
                      key={category.id}
                      whileHover={{ x: 2 }}
                    ...
                    <li className="text-gray-500 text-center text-sm">No categories available</li>
                  )}
                </ul>
              </div>
          ...
          <div className="hidden lg:flex lg:col-span-3 flex-col items-center">
            ...
            <ul className="grid grid-cols-1 gap-3 font-body w-full">
              {displayCategories.length > 0 ? displayCategories.map((category) => (
                ...
                <li className="text-gray-500 text-center">No categories available</li>
              )}
            </ul>
          </div>
