        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="relative group">
              ...
              <div className="hidden group-hover:grid grid-cols-2 absolute left-0 mt-0 w-64 bg-white shadow-xl rounded-md py-2 border border-purple-100 z-50">
                {collections?.length > 0 ? collections.map((collection) => (
                  ...
                  <div className="px-4 py-2 text-gray-500">No collections available</div>
                )}
              </div>
            </div>
            ...
            <Link
              ...
              className="ml-2 px-4 py-2 rounded-lg text-white bg-gradient-to-r from-purple-600 to-fuchsia-500 hover:from-purple-700 hover:to-fuchsia-600 transition-colors font-heading font-medium"
            >
              Become a Seller
            </Link>
...
/>
              ...
              <div className="py-4">
                ...
                <Link
                  href="/sell"
                  className="block mx-4 mt-2 mb-2 px-4 py-3 rounded-lg text-white text-center bg-gradient-to-r from-purple-600 to-fuchsia-500 hover:from-purple-700 hover:to-fuchsia-600 transition-colors font-heading"
                >
                  Sell on Flames
                </Link>
                  ...
                  {isDropdownOpen.mobileCat && (
                    <div className="bg-purple-50 grid grid-cols-2">
                      {categories?.length > 0 ? categories.map((category) => (
                        ...
                        <div className="col-span-2 px-4 py-2 text-gray-500 text-center">No categories available</div>
                      )}
                    </div>
                  )}
                </div>
                  ...
                  {isDropdownOpen.mobileColl && (
                    <div className="bg-purple-50 grid grid-cols-2">
                      {collections?.length > 0 ? collections.map((collection) => (
                        ...
                        <div className="col-span-2 px-4 py-2 text-gray-500 text-center">No collections available</div>
                      )}
                    </div>
                  )}
                </div>
