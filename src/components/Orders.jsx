...
export default function Orders() {
  ...
  return (
    <main className="flex flex-col justify-center bg-gray-50 gap-4 p-5">
      <h1 className="text-2xl font-heading text-center text-gray-800 font-semibold">My Orders</h1>
      {(!orders || orders?.length === 0) && (
        <div className="flex flex-col items-center justify-center gap-3 py-11">
          ...
          <h1 className="text-gray-800">You have no order</h1>
        </div>
      )}
